        ...
        { \href{https://gorillalogic.com/}{Gorilla Logic} }
        {
            \begin{itemize}
                ...
                \begin{itemize}
                    ...
                    % \item TODO: Review configurations made with EF, using FluentAPI,and ones mentioned bellow Configured EF and customized some functionality to add seed data, modify predefined entities.
                    % \item Started to develop an architecture that will support multi-tenant by configuring DB, customizing url/queries, manipulating session to reflect tenant data, extending entities functionality.
                \end{itemize}
...
{
   {\textbf{Web Development:}} .NET Core/ASP, HTML, CSS, Bootstrap, Blazor, JS, TS, Node, Express, Vue, Angular, SignalR, jQuery, AJAX, Tailwind, Material Angular, Django, React.\\\\
...
\section{Certifications}
{
    \begin{twenty}
        ...
        % \twentyitem {2020}{\href{http://ude.my/UC-8b854042-ac78-4c5b-a412-65ba63899017}{Learn Perl 5 By Doing It}}{Udemy}{}
