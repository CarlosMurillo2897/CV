        ...
        { \href{https://www.growthaccelerationpartners.com/}{Growth Acceleration Partners}}
        {
            \begin{itemize}
                ...
                \begin{itemize}
                    ...
                    % \item Stored Procedures creation in order to improve heavy logic and several SQL queries.
                    ...
                    % \item Definition of Components + each style/logic/testing + UI/UX design improvements.
                    ...
                    %\item Implemented SonarQube platform with help of Jenkins Tasks as a CI tool that will help on code analysis, code enhancements in a safer and cleaner way.
